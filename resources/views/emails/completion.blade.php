...
<head>
    ...
    <title>Course Completion - King Driving School</title>
...
<body width="100%" bgcolor="#F7B888" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #F7B888; text-align: left;">
        <div
            ...
            Congratulations on completing your driving course at King Driving School!
        </div>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="border-radius: 50px; background: #26a4d3; text-align: center;"
                                                    class="button-td">
                                                    <a href="https://kingdrivingschool.com/" class="button-a"
