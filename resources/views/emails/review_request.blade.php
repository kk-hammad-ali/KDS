...
<head>
    ...
    <title>We Value Your Feedback! - King Driving School</title>
    ...
    <center style="width: 100%; background: #F7B888; text-align: left;">
        ...
        <div style="max-width: 680px; margin: auto;" class="email-container">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%"
                ...
                <tr>
                    <td bgcolor="#F7B888" align="center" valign="top"
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tr>
                                    <td valign="top" align="center"
                                        style="text-align: center; padding: 10px 20px 15px 20px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 1.8; color:#0f3462;">
                                        <h1 style="margin: 0;">We Value Your Feedback!</h1>
                                        <p style="margin: 0 40px;">
                                            Dear {{ $student->user->name }},<br>
                                            It's been a week since you started your course at King Driving School, and
                                            we hope
                                            you're enjoying the experience! We would love to hear your feedback.
                                        </p>
                                        <p style="margin: 25px 40px;">
                                            Please take a few minutes to provide us with your thoughts and suggestions
                                            through
                                ...
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="https://g.co/kgs/GZ5vz9b" class="button-a"
                                            style="display: inline-block; background-color: #FF8F1F; color: white; padding: 15px 30px; text-decoration: none; border-radius: 50px; font-family: 'Montserrat', sans-serif; font-size: 16px; font-weight: bold;">
                                            Leave a Review
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <p style="margin: 0;">Thanks for choosing King Driving School. We look forward to
                                        helping you on your driving journey.</p>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
