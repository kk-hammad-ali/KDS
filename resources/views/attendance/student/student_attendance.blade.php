    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: @json($attendanceEvents), // Load student attendance events from backend
                    ...
                    if (element) {
                        if (attendance === 'present') {
                            ...
                            info.el.classList.add(
                                'fc-event-present'); // Add class for present attendance
                        } else if (attendance === 'absent') {
                            element.innerHTML =
                                `<i class="fas fa-times-circle"></i> ${info.event.title}`;
                            info.el.classList.add('fc-event-absent'); // Add class for absent attendance
                        }
                    }
                },
            });
