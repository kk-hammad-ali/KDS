    ...
    <div class="container-fluid p-0">
        <div class="position-relative" style="height: 50vh;">
            ...
            <div class="position-absolute" style="top: 30%; left: 10%;">
                <h1 class="display-3 fw-bold text-light">Bike (CD-70)</h1>
                <p class="h4 fw-bold text-light">Detailed information of Bike (CD-70)driving course</p>
            </div>
        </div>
    </div>
    ...
    <div id="courseInfo" class="content-section">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/hpic1.png" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                <div class="col-md-6">
                    <img src="/images/hpic2.png" class="img-fluid" alt="Responsive image">
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/hpic3.png" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
    </div>
