    ...
    <div class="container-fluid p-0">
        <div class="position-relative" style="height: 50vh;">
            ...
            <div class="position-absolute" style="top: 30%; left: 10%;">
                <h1 class="display-3 fw-bold text-light">Toyota Vitz - Automatic</h1>
                <p class="h4 fw-bold text-light">Detailed information of Toyota Vitz driving course</p>
            </div>
        </div>
    </div>
    ...
    <div id="courseInfo" class="content-section">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/vpic1.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                <div class="col-md-6">
                    <img src="/images/vpic2.jpg" class="img-fluid" alt="Responsive image">
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/vpic3.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-check-circle"></i> <strong>Training Hours Per Week</strong><br> 5
                                    Hours </li>
                                <li><i class="fa fa-check-circle"></i> <strong>Pick & drop charges Will be according to
                                        location</strong></li>
                                <li><i class="fa fa-check-circle"></i> <strong>Air conditioned facility available in
                                        car</strong></li>
