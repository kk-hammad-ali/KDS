...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="position-relative" style="height: 50vh;">
            <img src="/images/honda.jpeg" class="w-100 h-100" style="object-fit: cover;">
            <div class="position-absolute" style="top: 30%; left: 10%;">
                <h1 class="display-3 fw-bold text-light">Daihatsu Mira - Automatic</h1>
                <p class="h4 fw-bold text-light">Detailed information of Daihatsu Mira driving course</p>
            </div>
        </div>
    </div>
    ...
    <div id="courseInfo" class="content-section">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/mi1.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                <div class="col-md-6">
                    <img src="/images/mi2.jpg" class="img-fluid" alt="Responsive image">
                </div>
                <div class="col-md-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>&#8226; Cultivate the right driving habits and getting acquainted with traffic regulations and lane discipline..</li>
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/mi3.jpeg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card pricing-card border">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"><del>PKR 30,000</del> PKR 27,000</h6>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-check-circle"></i> <strong>Training Hours Per Week</strong><br> 5 Hours </li>
                                <li><i class="fa fa-check-circle"></i> <strong>Auto Transmission</strong></li>
                                ...
                                <li><i class="fa fa-check-circle"></i> <strong>60 Minutes Daily</strong></li>
                                <li><i class="fa fa-check-circle"></i> <strong>Change Of Driving Route Will Be Charged Separately 10,000/-</strong>
                            </ul>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card pricing-card border">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Regular</h5>
                            <h6 class="card-subtitle mb-2 text-muted"><del>PKR 42,000</del> PKR 40,500</h6>
                            <p class="card-text">(5% VAT applicable on Eco Drive Fees)</p>
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-check-circle"></i> <strong>14 Days Practical Driving</strong></li>
                                <li><i class="fa fa-check-circle"></i> <strong>01 Theory Class</strong>
                                <li><i class="fa fa-check-circle"></i> <strong>60 Minutes Daily</strong></li>
                                <li><i class="fa fa-check-circle"></i> <strong>Change Of Driving Route Will Be Charged Separately 10,000/-</strong>
                            </ul>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card pricing-card border">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Regular</h5>
                            <h6 class="card-subtitle mb-2 text-muted"><del>PKR 20,000</del> PKR 17,000</h6>
                            <p class="card-text">(5% VAT applicable on Eco Drive Fees)</p>
                            <ul class="list-unstyled">
                                <li><i class="fa fa-check-circle"></i> <strong>Training Days*</strong><br> 10 </li>
                                <li><i class="fa fa-check-circle"></i> <strong>Training Hours Per Week</strong><br> 2.5 Hours </li>
                                <li><i class="fa fa-check-circle"></i> <strong>Auto transmission</strong><br></li>
                                <li><i class="fa fa-check-circle"></i> <strong>09 Days Practical Driving</strong></li>
                                <li><i class="fa fa-check-circle"></i> <strong>01 Theory Class</strong>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card pricing-card border">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"><del>PKR 27,000</del> PKR 25,500</h6>
                            <p class="card-text">(5% VAT applicable on Eco Drive Fees)</p>
                            <ul class="list-unstyled">
                                <li><i class="fa fa-check-circle"></i> <strong>Training Days*</strong><br> 15 </li>
                                <li><i class="fa fa-check-circle"></i> <strong>Training Hours Per Week</strong><br> 2.5 Hours </li>
                ...
                <div class="col-md-12">
                    <div class="p-3 border">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr><td>8.25</td><td>8.25</td><td>8.25</td></tr>
                                <tr><td>9.25</td><td>9.25</td><td>9.25</td></tr>
                                <tr><td>10.30</td><td>10.30</td><td>10.30</td></tr>
                                <tr><td>11.30</td><td>11.30</td><td>11.30</td></tr>
                                <tr><td>12.35</td><td class="bg-light"></td><td>12.35</td></tr>
                                <tr><td>13.35</td><td>2.30</td><td>13.35</td></tr>
                                <tr><td>3.30</td><td>3.30</td><td>3.00</td></tr>
                                <tr><td>4.30</td><td>4.30</td><td>4.00</td></tr>
                                <tr><td>18.00</td><td>18.00</td><td>18.00</td></tr>
                                <tr><td>19.00</td><td>19.00</td><td>19.00</td></tr>
                                <tr><td>20.00</td><td>20.00</td><td>20.00</td></tr>
                                <tr><td>21.00</td><td>21.00</td><td>21.00</td></tr>
                                <tr><td>22.00</td><td>22.00</td><td>22.00</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="p-3 border">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>● Should you wish to stop the classes due to health issues, please inform us 1 hour in advance so your training will be extended accordingly.</li>
                            <li>● In case your instructor is absent, we will arrange a replacement instructor & should we fail to provide another instructor, your training will be extended accordingly.</li>
                            <li>● Should you wish to stop the classes due to health issues, please inform us 48 hours in advance of your scheduled training to avoid absent fees.</li>
                            <li>● Your Learning Permit will be valid for 3 months from the time of issue date (Renewal Charges will be applied as per Learner policy).</li>
                        </ul>
                    </div>
                </div>
            </div>
