    ...
    <div class="container-fluid p-0">
        <div class="position-relative" style="height: 50vh;">
            ...
            <div class="position-absolute" style="top: 30%; left: 10%;">
                <h1 class="display-3 fw-bold text-light">Alto Manual 2022</h1>
                <p class="h4 fw-bold text-light">Detailed information of Alto Manual 2022 driving course</p>
            </div>
        </div>
    </div>
    ...
    <div id="courseInfo" class="content-section">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/pic11.png" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                <div class="col-md-6">
                    <img src="/images/pic22.jpg" class="img-fluid" alt="Responsive image">
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row ms-4 me-4 py-2 px-4">
                ...
                <div class="col-md-6">
                    <img src="/images/pic32.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card pricing-card border">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"><del>PKR 43,500</del> PKR 40,500</h6>
                            <p class="card-text">(5% VAT applicable on Eco Drive Fees)</p>
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-check-circle"></i> <strong>01 Theory Class</strong>
                                <li><i class="fa fa-check-circle"></i> <strong>60 Minuts Daily</strong></li>
                            </ul>
