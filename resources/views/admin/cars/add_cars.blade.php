                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('make') is-invalid @enderror" id="make" name="make" value="{{ old('make') }}" placeholder="Enter car make" required>
                                @error('make')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('model') is-invalid @enderror" id="model" name="model" value="{{ old('model') }}" placeholder="Enter car model" required>
                                @error('model')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
